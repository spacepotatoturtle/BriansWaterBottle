...
@Autonomous(group = "Performance", name = "AutoF")
public class AutoF extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d pickupPlace = new Pose2d(125, -67, 0);
        Pose2d zonePose;
        ...
        Trajectory toPickup1 = drive.trajectoryBuilder(powerPoseFinal)
                .splineToLinearHeading(pickupPlace, pickupPlace.getHeading())
                .build();

        Trajectory toZone0 = drive.trajectoryBuilder(pickupPlace)
                .splineToLinearHeading(zonePose, -zonePose.getHeading())
