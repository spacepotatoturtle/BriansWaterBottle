...
public class CombinedTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while(opModeIsActive()) {
            ...
            shooter.shoot(gamepad2.left_trigger, gamepad2.dpad_right, gamepad2.dpad_left, gamepad2.left_trigger > 0 || gamepad2.x, gamepad2.left_trigger == 0 || gamepad2.y, gamepad2.right_trigger > 0.05, gamepad2.dpad_down, gamepad2.dpad_up);
            wobbler.wobble(gamepad1.x, gamepad1.dpad_up || gamepad1.a, false, gamepad1.dpad_down, gamepad1.dpad_left, gamepad1.dpad_right || gamepad1.a, gamepad2.y, gamepad2.a);
